package com.epam.springboot.aop.logging;
...
public class LoggableAspect {
    ...
    @Around(value = "callAt(annotation)",argNames = "point,annotation")
    public Object log(ProceedingJoinPoint point,Loggable annotation) throws Throwable {
